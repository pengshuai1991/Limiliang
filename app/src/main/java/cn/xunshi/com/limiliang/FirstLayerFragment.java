...
public class FirstLayerFragment extends LazyFragment {
	...
	private class MyAdapter extends IndicatorFragmentPagerAdapter {
		...
		public View getViewForTab(int position, View convertView, ViewGroup container) {
			...
			switch(position){
				case 0:
					textView.setText("优秀作品");
					break;
				case 1:
					textView.setText("设计师");
					break;
				case 2:
					textView.setText("寻饰风采");
					break;

			}
			}else if(tabName.equals("最新推荐")){
				textView.setText("最新作品");
			}else{
				switch(position){
					case 0:
						textView.setText("关心");
		...
		public Fragment getFragmentForPage(int position) {
			...
			if(tabName.equals("我") && position==1 || tabName.equals("主页") && position == 2 ){
				RegOrLogFragment regOrLogFragment = new RegOrLogFragment();
				return  regOrLogFragment;
			}
